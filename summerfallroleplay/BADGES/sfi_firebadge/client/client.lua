...
RegisterNetEvent('fire-badge:badgeanim')
AddEventHandler('fire-badge:badgeanim', function(prop_name)
...
RegisterNetEvent('fire-badge:open')
AddEventHandler('fire-badge:open', function(who, image)
