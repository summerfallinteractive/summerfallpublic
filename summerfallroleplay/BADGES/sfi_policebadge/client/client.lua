...
RegisterNetEvent('police-badge:badgeanim')
AddEventHandler('police-badge:badgeanim', function(prop_name)
...
RegisterNetEvent('police-badge:open')
AddEventHandler('police-badge:open', function(who, image)
