Locales['en'] = {
  ...
  ['lifeguard_wear'] = 'lifeguard Outfit',
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~Lifeguard~s~',
  -- Vehicle interaction
